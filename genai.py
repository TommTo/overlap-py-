...
#Alle woorden uit de artikel worden in een list gezet.
...
#met een if in een for loop worden artikelen met elkaar vergeleken:
...
#stap 6, alle stop woorden zijn verwijderd van artikel 1
...
#stap 8, len() functie pakt de lengte van de string variabele. Dit betekent dat de lengte in characters wordt berekend en niet in woorden. 
